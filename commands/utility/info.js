...
module.exports.run = async (client, message, args) => {
    cpuStat.usagePercent(function (err, percent) {
        ...
        let embed = new Discord.RichEmbed()
            .setColor("0x9400d3")
            .setAuthor("Aurora's Information", "https://cdn.discordapp.com/app-icons/509956886041329665/0eb7e6c1824aadce95d6c33d4ce933ca.png")
